...
import icoPan from './~/admin/assets/ico-pan-hand.svg'
import icoZoom from './~/admin/assets/ico-zoom-in.svg'
import icoReset from './~/admin/assets/ico-home.svg'
import icoZoomIn from './~/admin/assets/ico-plus.svg'
import icoZoomOut from './~/admin/assets/ico-minus.svg'
import icoSelect from './~/admin/assets/ico-select.svg'
import icoMenu from './~/admin/assets/ico-menu.svg'
